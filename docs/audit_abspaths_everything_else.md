...
| File | Line | Token | Why |
|---|---|---|---|
| `scripts/hooks/handlers/Stop/05_intent_without_action_async.py` | 44 | `/opt/homebrew/bin/python3` | in a comment: `PYTHON = AI_PYTHON  # was hardcoded ...` (already fixed) |
...
| `content/ai_context_files/instructions/how_tos/instr_cli_agents.md` | 154 | `/Applications/Google\ Chrome…` | doc example command (macOS-specific by nature) |
