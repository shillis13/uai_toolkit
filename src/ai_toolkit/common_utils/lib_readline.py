...
Usage:
    from ai_toolkit.common_utils.lib_readline import setup_readline, bind_key, IS_LIBEDIT
    from ai_toolkit.common_utils.lib_readline import make_session_completer
...
def make_session_completer(limit: int = 50) -> Callable:
    ...
    Usage:
        from ai_toolkit.common_utils.lib_readline import setup_readline, make_session_completer
