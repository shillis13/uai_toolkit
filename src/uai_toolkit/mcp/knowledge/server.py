"""knowledge MCP server (uai_toolkit) — guidance vertical slice.
...
at uai_toolkit.mcp.shared.tool_registry and can be reintroduced when wanted.

Run: uai-mcp-knowledge  (stdio MCP server; needs uai_toolkit[mcp] + AI_ROOT content)
"""
...
from uai_toolkit.mcp.knowledge.tools import (
    knowledge_guidance,
    knowledge_memory,
    knowledge_search,
    knowledge_jsonl,
